...
# git
#ZSH_THEME_GIT_PROMPT_PREFIX=" on %{$fg_no_bold[green]%}\uE0A0 ";
#ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%} ";
#ZSH_THEME_GIT_PROMPT_DIRTY=" %{$fg_no_bold[red]%}[✖%{$fg_no_bold[orange]%}]";
...
PROMPT='$(real_time) $(directory) $(command_status) ';
